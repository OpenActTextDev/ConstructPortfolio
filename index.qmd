...
schedule <- data.frame(
  Time = c(
    "9:00–9:20 am", "9:20–9:50 am", "9:50–10:30 am",  "10:30–11:00 am",
  ...
  Activity = c(
    ...
    "<i>Coffee Break</i>",
    "<b>Topic 2</b>. Basic Tools: Dependence, Risk Retention Functions and Risk Measures. Optimal Portfolio Construction.",
    "Participants will work with code to generate dependent variables as well as to quantify risk measures and risk retention functions. You also learn to optimize basic portfolios.",
    "<i>Lunch</i>",
    "<b>Topic 3</b>. Two Case Studies: Optimizing Risk Retention with Australian and Wisconsin Data",
    "Participants will explore optimizing risk portfolios using Australian large company data and Wisconsin commercial insurance data",
    "<i>Break</i>",
...
**Details for the Short Course Workshop Schedule are UNDER CONSTRUCTION**
...
schedule <- data.frame(
  ...
  Activity = c(
    "<b>Welcome</b>, Introduction to the workshop,<br>&nbsp;&nbsp;&nbsp;How it will work, What you can get out of it.",
    '<b>Topic 1. </b> Introduction to Constructing Insurable Risk Portfolios <br>
    <a href="https://github.com/OpenActTextDev/ConstructPortfolio/blob/main/Presentations/ColombiaSC_Intro2026.pdf">Topic 1 Pdf Slides</a>'  ,
    ...
    <a href="https://notebook.google.com/notebook/3970659b-a920-4201-8ecc-c83512405bb4?pli=1">Topic 1 Gemini Notebook</a>',
    "<i>Coffee Break</i>",
    '<b>Topic 2</b>. Basic Tools: Dependence, Risk Retention Functions and Risk Measures. Optimal Portfolio Construction.
    <br>
    <a href="https://github.com/OpenActTextDev/ConstructPortfolio/blob/main/Presentations/ColombiaSC_BasicTools2026.pdf">Topic 2 Pdf Slides</a>',
    'Participants will work with code to generate dependent variables as well as to quantify risk measures and risk retention functions. You also learn to optimize basic portfolios.<br>
    <a href="https://github.com/OpenActTextDev/ConstructPortfolio/blob/main/Notebooks/BasicTools.ipynb">Topic 2 Jupyter Notebook -Basic Tools</a>',
    "<i>Lunch</i>",
    "<b>Topic 3</b>. Two Case Studies: Optimizing Risk Retention with Australian and Wisconsin Data",
    'Participants will explore optimizing risk portfolios using Australian large company data and Wisconsin commercial insurance data<br>
    <a href="https://github.com/OpenActTextDev/ConstructPortfolio/blob/main/Notebooks/ANUCaseStudy.ipynb">Topic 3 Jupyter Notebook - ANU Case Study</a> <br><a href="https://github.com/OpenActTextDev/ConstructPortfolio/blob/main/Notebooks/WisconsinCaseStudy.ipynb">Topic 3 Jupyter Notebook - Wisconsin Case Study</a>',
    "<i>Break</i>",
    "<b>Topic 4</b>. Incorporating Spatial Dependence",
    'Participants will explore Florida flood insurance data
    <br>
    <a href="https://github.com/OpenActTextDev/ConstructPortfolio/blob/main/Notebooks/SpatialRiskPool.ipynb">Topic 4 Jupyter Notebook - Optimizing Spatially Dependent Risk Pools</a>' ,
    "<i>Wrap-Up</i>"
  ),  stringsAsFactors = FALSE)
...
-   [Short Course 2025 Repo](https://github.com/OpenActTextDev/ActuarialRegression/) - this is the Github repository where we will store data for the short course.
