...
schedule <- data.frame(
  ...
  Activity = c(
    ...
    "Participants will explore features and learn how to construct an optimal investment portfolio",
    "Coffee Break",
    "<b>Topic 2</b>. Risk Retention Functions and Risk Measures for Single Risks and Several Independent Risks",
    "Participants will explore health data",
    "Lunch",
    "<b>Topic 3</b>. Optimizing Retention with ANU Data",
    "Participants will explore Wisconsin Data",
    "Break",
...
# kbl(schedule,
#   caption = "<b>Detailed Schedule</b>", escape = FALSE,
#   align = c("c", "l"),   format = "html",
#   table.attr = 'style="width:790px; table-layout:fixed;"') %>%  
#   kable_styling( full_width = FALSE,  position = "center",  bootstrap_options = "condensed" ) %>%
#   column_spec( 1, width = "140px" , border_right = TRUE,
#     extra_css = paste("width:140px;", "min-width:140px;", "max-width:140px;", "white-space:nowrap;")
#   ) %>%
#   column_spec(2,  width = "650px",
#     extra_css = paste("width:650px;", "min-width:650px;", "max-width:650px;", 
#                       "overflow-wrap:break-word;" ) ) %>%
#   row_spec(  c(1, 4, 7, 10),   extra_css = "border-bottom:1px solid black;" )
...
I am sharing read-only Gemini Notebooks with you. **This tool is like a smart study assistant that only knows the content I uploaded — so it is focused, grounded, and safe to use!**
...
*  What are the five main accounts on a balance sheet?
