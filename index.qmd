...
Workshop held in conjunction with the [IX Simposio Internacional de Actuaría](https://simposiointernacionalaca.com/).
...
schedule <- data.frame(
  ...
  Activity = c(
    "Welcome, Introduction to the workshop,<br>&nbsp;&nbsp;&nbsp;How it will work, What you can get out of it.",
    "Topic 1. Introduction to <i>Constructing Insurable Risk Portfolios</i>",
    "Participants will explore features and learn how to construct an optimal investment portfolio",
    "Coffee Break",
    "Topic 2. Risk Retention Functions and Risk Measures for Single Risks and Several Independent Risks",
    "Participants will explore health data",
    "Lunch",
    "Topic 3. Optimizing Retention with ANU Data",
    "Participants will explore Wisconsin Data",
    "Break",
    "Topic 4. Incorporating Spatial Dependence",
    "Participants will explore Florida flood data",
    "Wrap-Up"
...
[Try my Chapter 1 Google Notebook](https://notebook.google.com/notebook/3970659b-a920-4201-8ecc-c83512405bb4?pli=1)
